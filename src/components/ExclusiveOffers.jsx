    ...
    <div className='flex flex-col items-center px-6 md:px-16 lg:px-24 xl:px-32 pt-20 pb-30'>
        ...
        <div className='grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6 mt-12'>
            {exclusiveOffers.map((item) => (
                <div key={item._id} className='group relative flex flex-col items-start justify-between gap-1 pt-12 md:t-18 px-4 rounded-xl text-white bg-no-repeat bg-cover' style={{backgroundImage: `url(${item.image})`}}>
                    ...
                    <div>
                        ...
                        <button className='flex items-center gap-2 font-medium text-base'>View All Offers
