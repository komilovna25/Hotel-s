...
const MyBooking = () => {
    ...
    return (
        <div className='py-28 md:pb-35 md:pt-32 px-4 md:px-16 lg:px-24 xl:px-32'>
            ...
            <Title title='My Bookings' subTitle='Easilty manage your past, current, and upcoming hotel reservations in one place. Plan your trips seamlessly with just a few clicks' align='left'/>
                   ...
                   {bookings.map((booking) => (
                    <div key={booking._id} className='grid grid-cols-1 md:grid-cols-[3fr_2fr_1fr] w-full border-b border-gray-300 py-6 first:border-t'>
                        <div className='flex flex-col md:flex-row'>
                            <img src={booking.room.images[0]} alt="hotel" className='min-md:w-44 rounded shadow object-cover'/>
                        ...
                        <div className='flex flex-row md:items-center md:md:gap-12 mt-3 gap-8'>
                            <div>
                                <p>Check-In:</p>
